...
syn keyword javaTypedef		this super null
...
if exists("java_highlight_all")  || exists("java_highlight_java")  || exists("java_highlight_java_lang") 
  ...
  syn keyword javaR_JavaLang NegativeArraySizeException ArrayStoreException IllegalStateException RuntimeException IndexOutOfBoundsException UnsupportedOperationException ArrayIndexOutOfBoundsException ArithmeticException ClassCastException EnumConstantNotPresentException StringIndexOutOfBoundsException IllegalArgumentException IllegalMonitorStateException IllegalThreadStateException NumberFormatException NullPointerException TypeNotPresentException SecurityException CloneNotSupportedException Exception NoSuchMethodException IllegalAccessException NoSuchFieldException Throwable InterruptedException ClassNotFoundException InstantiationException SQLException MongoException ServletException ExecutionException IOException InvalidClassException InvalidParameterException ConnectException

  syn cluster javaTop add=javaR_JavaLang
  syn cluster javaClasses add=javaR_JavaLang
  JavaHiLink javaR_JavaLang javaR_Java
  syn keyword javaC_JavaLang Process RuntimePermission StringKeySet CharacterData01 Class ThreadLocal ThreadLocalMap CharacterData0E Package Character StringCoding Long ProcessImpl ProcessEnvironment Short AssertionStatusDirectives 1PackageInfoProxy UnicodeBlock InheritableThreadLocal AbstractStringBuilder StringEnvironment ClassLoader ConditionalSpecialCasing CharacterDataPrivateUse StringBuffer StringDecoder Entry StringEntry WrappedHook StringBuilder StrictMath State ThreadGroup Runtime CharacterData02 MethodArray Object CharacterDataUndefined Integer BigInteger Gate Boolean Enum Variable Subset StringEncoder Void Terminator CharsetSD IntegerCache CharacterCache Byte CharsetSE Thread SystemClassLoaderAction CharacterDataLatin1 StringValues StackTraceElement Shutdown ShortCache String ConverterSD ByteCache Lock EnclosingMethodInfo Math Float Value Double DecimalFormat SecurityManager LongCache ProcessBuilder StringEntrySet Compiler MessageDigest Number NumberFormat BigDecimal UNIXProcess ConverterSE ExternalData CaseInsensitiveComparator CharacterData00 NativeLibrary Collections List ArrayList LinkedList Map HashMap LinkedHashMap TreeMap Set HashSet Connection Statement PreparedStatement ResultSet ResultSetMetaData Driver DriverManager JSON Mongo MongoClient MongoClientOptions MongoCredential BasicDBObject ServerAddress BasicDBList CommandResult DBCursor DBCollection DBObject AggregationOutput QueryOperators ArrayNode JsonNode JsonNodeFactory JsonParser JsonObject JsonArray JsonParser Jsoner ObjectMapper ObjectNode HttpServlet HttpServletRequest HttpServletRequestWrapper HttpServletResponse Callable Executors ExecutorService CompletionService ExecutorCompletionService PrintWriter Enumeration Field Method File Arrays Future Promise Optional TimeUnit Locale Date DateTime DateTimeFormatter ZoneOffset DateFormat SimpleDateFormat LocalDate ParseException DeserializationException ZoneId Calendar GregorianCalendar TimeZone FileInputStream FileOutputStream Properties ServletContext InputStream OutputStream ServletContextEvent ServletContextListener BufferedReader FileReader InputStreamReader OutputStreamReader OutputStreamWriter Logger Play Result URLEncoder Document DocumentBuilder DocumentBuilderFactory IOUtils Json Node NodeList Element Iterator System Utils StringUtils ExceptionUtils Lists Maps Sets Collectors Stack Context LambdaLogger RequestHandler BitSet
  ...
  JavaHiLink javaLangObject		     javaTypedef
...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaAnnotation		SpecialComment
  ...
  JavaHiLink javaType			Identifier
  JavaHiLink javaClasses		Identifier
