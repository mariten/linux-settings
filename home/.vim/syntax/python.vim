...
syn keyword pythonLibrary	string re struct difflib StringIO cStringIO
syn keyword pythonLibrary	textwrap codecs unicodedata stringprep fpformat
...
syn keyword pythonLibrary	os fileinput stat statvfs filecmp tempfile
syn keyword pythonLibrary	glob fnmatch linecache shutil dircache macpath

syn keyword pythonLibrary	pickle cPickle copy_reg shelve marshal anydbm dbm
syn keyword pythonLibrary	whichdbm gdbm dbhash bsddb dumbdbm sqlite3

syn keyword pythonLibrary	zlib gzip bz2 zipfile tarfile

syn keyword pythonLibrary	csv ConfigParser robotparser netrc xdrlib plistlib

syn keyword pythonLibrary	hashlib hmac md5 sha

syn keyword pythonLibrary	os io time argparse optparse getopt logging getpass
syn keyword pythonLibrary	curses platform errno ctypes

syn keyword pythonLibrary	select threading thread dummy_threading dummy_thread
syn keyword pythonLibrary	multiprocessing mmap readline rlcompleter

syn keyword pythonLibrary	subprocess socket ssl signal popen2 asyncore asynchat

syn keyword pythonLibrary	email json mailcap mailbox mhlib mimetools mimetypes quopri uu
syn keyword pythonLibrary	MimeWriter mimify multifile rfc822 base64 binhex binascii
...
syn keyword pythonLibrary	audioop imageop aifc sunau wave chunk colorsys imghdr sndhdr ossaudiodev

syn keyword pythonLibrary	gettext locale cmd shlex

syn keyword pythonLibrary	Tkinter ttk Tix ScrolledText turtle

syn keyword pythonLibrary	pydoc doctest unittest

syn keyword pythonLibrary	bdb pdb hotshot timeit trace distutils ensurepip

syn keyword pythonLibrary	sys sysconfig __builtin__ future_builtins __main__ warnings contextlib
syn keyword pythonLibrary	abc atexit traceback __future__ gc inspect site fpectl

syn keyword pythonLibrary	posix pwd spwd grp crypt dl termios tty pty fcntl pipes posixfile nis syslog
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonLibrary	Identifier
