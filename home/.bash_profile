...
alias gitlogp='git log --follow -p'
alias gitprunebranchesremote='git remote prune origin --dry-run'
alias gitprunebranchesremoterun='git remote prune origin'
alias gitprunebrancheslocal='git branch --merged master | grep -v "master$" | grep -v "develop$" | grep -v "staging$"'
alias gitprunebrancheslocalrun='git branch --merged master | grep -v "master$" | grep -v "develop$" | grep -v "staging$" | xargs git branch -d'
